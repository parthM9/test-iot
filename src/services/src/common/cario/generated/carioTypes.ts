export const CARIO_CREATE_EVENT_NEAR_DEL = "NEARDEL";

/** Custom event information */
export interface ICreateEvent {
  /** Consignment Guid identifier */
  consignmentID: string;
  /** Local time of the event */
  eventTime: string;
  /** Event Code - refer to your freight manager for allowed codes */
  eventType: string | undefined;
  /** Optional GPS latitude of the event */
  latitude?: number | undefined;
  /** Optional GPS longitude of the event */
  longitude?: number | undefined;
  /** Additional information relating to the event (e.g. name of person receiving goods with a delivered event) */
